...
class _FalciSayfasiState extends State<FalciSayfasi> {
  ...
  void durumlarDegistir() {
    setState(() {
      cevap = Random().nextInt(5) + 1;
      yanitlar[cevap];
      print(yanitlar[cevap]);
    });
  }

  void durumlarDegistir1() {
    setState(() {
      cevap = 5 + Random().nextInt(5) + 1;
      yanitlar[cevap];
      print(cevap);
    });
  }

  void durumlarDegistir2() {
    setState(() {
      cevap = 10 + Random().nextInt(5) + 1;
      yanitlar[cevap];
      print(yanitlar[cevap]);
    });
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: CircleAvatar(
                  ...
                  child: ClipRRect(
                    child: Image(
                      image: AssetImage('assets/falci.png'),
                    ),
                  ),
                ),
              ),
